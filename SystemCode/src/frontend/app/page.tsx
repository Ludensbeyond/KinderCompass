...
type Route = { total_distance_km: number; distance_method: string; travel_distance_km: number; travel_duration_minutes?: number | null; travel_mode: "drive" | "unavailable"; route_method: string; route_coordinates: { latitude: number; longitude: number }[]; estimated: boolean; fallback_reason?: string | null; schedule: Stop[] };
      ...
      <div className="workspace">
        ...
        <section className="rightColumn">
          <div className="displayPanel">
            ...
            <div className="displayBody">
              ...
              {tab === "form" && stage === "choose" && <div className="contentForm">
                <div className="contentHead"><p>Location ready</p><h2>Home to preschools</h2><span>Home postal code: {homePostalCode}. Select preschools in Results to estimate driving distance and duration.</span></div>
              </div>}
          ...
          <div className="mapPanel">
            ...
            <LiveMap points={mapPoints} routes={Object.values(routes)} />
